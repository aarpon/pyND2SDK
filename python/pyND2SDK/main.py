...
if __name__ == "__main__":
    ...
    file_handle = c_nd2ReadSDK.pLIM_FileOpenForRead(filename)
    if file_handle == 0:
        ...
        attr = c_nd2ReadSDK.pLim_FileGetAttributes(file_handle)
        print(attr)

        # Close the file
        result = c_nd2ReadSDK.pLIM_FileClose(file_handle)
        print(result)
